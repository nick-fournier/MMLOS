...
- A bicycle arrives at the first stage during a green phase. The delay is the average remaining green time from the first phase, plus a startup time.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzMjgwMTg1OSwtMTU2NjgxMTQ2NywtMT

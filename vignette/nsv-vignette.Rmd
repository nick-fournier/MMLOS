...
Alright now lets compare the results a bit. Basically what I am doing here is combining the two results into a single data table and formatting it to be plotted. The links with negative LOS is due to parking-protected bicycle lanes. In general we can see that the revised version provides a more conservative outcome, i.e., a worse LOS score for the segment.

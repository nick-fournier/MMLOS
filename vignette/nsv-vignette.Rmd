...
Okay now that we've gone through a short example, that should be enough to get going. More to come in future revisions. For more project details see the working paper "Bicycle Level of Service: Accounting for protected lanes, traffic exposure, and delay" 
